...
\cppfile{mathyStuff/grundyNumbers.cpp}
\subsection{Gauss method for solving system of linear equations}
\cppfile{mathyStuff/gaussMatrixSolver.cpp}
...
\subsection{Smallest circle enclosing a set of points}
\cppfile{geometry/SmallestEnclosingCircle.cpp}
\subsection{maximum number of points enclosed by a circle of fixed radius}
\cppfile{geometry/maxPointsEnclosedByCircle.cpp}
...
\subsection{Lazy persistent segment tree}
\cppfile{dataStructuresForRangeQueries/LazyPersistentSegmentTree.cpp}
...
\subsection{Set custom comparator (the same applies for map)}
